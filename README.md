NOTE: vendored upstream copy of flatcc. This README is from upstream `dvidelabs/flatcc` and
serves as a vendor snapshot. For authoritative docs, see the upstream project.
